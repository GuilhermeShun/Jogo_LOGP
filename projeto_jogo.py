...
def jogo(tela):
    ...
    while True:
        ...
        if not lancamento:
            ...
            pygame.draw.line(tela, (12, 60, 213), (int(bola.body.position.x), int(bola.body.position.y)), (int(bola.body.position.x)+int(0.1*velocidade_horizontal), int(bola.body.position.y)+int(0.1*velocidade_vertical)), 4)
