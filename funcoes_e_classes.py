...
class Cesta:
    ...
    #Cesta(LARGURA_DA_TELA-250, LARGURA_DA_TELA-150, LARGURA_DA_TELA-140, 400, 475, 250, 412)
        ...
        self.aro_esquerdo_shape.elasticity = 0.6
        self.rede_esquerda_shape.elasticity = 0.2
        self.rede_baixo_shape.elasticity = 0.2
        self.rede_direita_shape.elasticity = 0.2     
...
class Bola:
    def __init__(self):
        ...
        self.body.position = distancia_linha_de_3, (ALTURA_DA_TELA-100-self.radius)
    ...
    def respawn(self, variacao_horizontal=None, posicao_horizontal=None):
        if posicao_horizontal:
            self.body.position = (posicao_horizontal, (ALTURA_DA_TELA-100-self.radius))
        else:
            self.body.position = distancia_linha_de_3+variacao_horizontal, (ALTURA_DA_TELA-100-self.radius)
        self.body.velocity = (0, 0)
        self.shape.friction = 0
...
def exibir_tempo(tempo_em_milissegundos):
    ...
    mensagem = f'tempo: {tempo_em_segundos:.2f} s'
    texto_formatado = fonte.render(mensagem, True, (255, 255, 255))
